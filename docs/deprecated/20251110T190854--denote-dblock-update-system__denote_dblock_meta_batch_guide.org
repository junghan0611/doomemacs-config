...
#+begin_example
#+BEGIN: denote-links :regexp "변환\\|convert" :not-regexp nil :excluded-dirs-regexp "\\(meta\\|llmlog\\)" :sort-by-component nil :reverse-sort nil :id-only nil :include-date t
